...
class QualityGatesExecutor {
    ...
    async runCoverageGate() {
        try {
            ...
            const output = (0, child_process_1.execSync)('npm test -- --coverage --json', {
    ...
    async runCodeReviewGate() {
        try {
            ...
            const diff = (0, child_process_1.execSync)('git diff main...HEAD', {
                cwd: this.projectPath,
                encoding: 'utf-8',
                stdio: ['pipe', 'pipe', 'pipe']
            });
    ...
    async runGitSafetyGate() {
        try {
            ...
            const main = (0, child_process_1.execSync)('git rev-parse main', {
                cwd: this.projectPath,
                encoding: 'utf-8',
                stdio: ['pipe', 'pipe', 'pipe']
            }).trim();
            if (mergeBase !== main) {
                ...
                try {
                    (0, child_process_1.execSync)('git rebase main', {
                        cwd: this.projectPath,
                        stdio: 'pipe'
                    });
                    ...
                    try {
                        (0, child_process_1.execSync)('git rebase --abort', {
                            cwd: this.projectPath,
                            stdio: 'pipe'
                        });
                    }
            ...
            try {
                const commits = (0, child_process_1.execSync)('git log main..HEAD --format=%s', {
                    cwd: this.projectPath,
                    encoding: 'utf-8',
                    stdio: ['pipe', 'pipe', 'pipe']
                }).split('\n').filter(s => s.trim());
...
exports.QualityGatesExecutor = QualityGatesExecutor;
